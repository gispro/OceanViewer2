...
var metaDataConfigs = {
    ...
    "field": {
        ...
        "metaDataFields" : {
            ...
            "objectinfourl" : "Путь к информации по объекту",
            "descriptivekeywords" : "Ключевые слова",
            "objectversion" : "Версия объекта",
            "creationdate" : "Дата создания",
            "publicationdate" : "Дата публикации",
            "revisiondate" : "Дата ревизии",
            "elementstandardname" : "Стандартное наименование элемента",
            "referencesystems" : "Ссылающиеся системы",
            "elementtitle" : "Заголовок элемента",
            "elementshortname" : "Краткое наименование элемента",
            "elementname" : "Наименование элемента",
            "unitofmeasure" : "Единица измерения",
            "elementminvalue" : "Минимальное значение",
            "elementmaxvalue" : "Максимальное значение",
            "elementformat" : "Формат элемента",
            "elementprintdec" : "Dec печати элемента",
            "elementprintfield" : "Поле печати элемента"
        },
        "user": "esimo",
        "password" : "gisproesimo"
    }
